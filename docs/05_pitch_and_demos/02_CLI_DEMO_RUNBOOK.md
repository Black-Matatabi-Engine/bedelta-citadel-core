...
**Pruned venues (v1.1):** Uniswap V3 · Aave V3 · Morpho Blue — Wasm ABI v2 **RESERVED_ABI_V2** holes preserved at protocol bits 4–6. See [`docs/01_architecture/02_DEFENSE_MATRIX_AND_SSRC_CORE.md`](../01_architecture/02_DEFENSE_MATRIX_AND_SSRC_CORE.md).
...
pnpm demo:e2e
pnpm test       # Full System Regression Suite (228 test files | 1064 PASS clean)
```

Optional benchmark: `npx tsx scripts/grant-advanced-resilience-benchmark.ts`

→ Full verification matrix: [`VERIFICATION_MATRIX.md`](../06_verifications/01_VERIFICATION_MATRIX.md)
