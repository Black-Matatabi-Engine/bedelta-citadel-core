...
**Clock SSOT:** `Clock: JUDGE_SAFE (Deterministic Audit Epoch) · Network: Arbitrum One 42161` — emitted by [`examples/lib/eip1193-extension-helpers.ts`](../../examples/lib/eip1193-extension-helpers.ts) · seeded via [`examples/lib/demo-harness.ts`](../../examples/lib/demo-harness.ts).
