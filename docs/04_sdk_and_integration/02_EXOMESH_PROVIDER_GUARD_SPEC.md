...
| Buffer | Source | Role |
|--------|--------|------|
| `SOIL_FFI_REUSABLE_BUFFER` | `wasm-soil-ffi.ts` | Zero-alloc SSRC soil input encode |
...
| 02 | [`02_MARKET_INTELLIGENCE_AND_COMPETITOR_AUDIT.md`](./04_MARKET_INTELLIGENCE_AND_COMPETITOR_AUDIT.md) |
