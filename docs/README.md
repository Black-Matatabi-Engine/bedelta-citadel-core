...
> **Vitest SSOT:** **194 test files | 845 PASS Clean (100% PASS)** · `pnpm test` · `pnpm demo` (12 Tri-Pillar scenarios) · `pnpm demo:e2e` (5-step macro) · live proof `GET /api/grant-audit`.
