...
> **Baseline:** Vitest **194 test files \| 845 PASS Clean (100% PASS)** · Wasm hot-path **70.88 KiB gzip** (`pkg/soil_core.wasm` **< 28 KiB**) · Shield **p50 ~106 µs**
...
| **Wasm hot-path** | **70.88 KiB gzip** · `pkg/soil_core.wasm` **< 28 KiB** · `pass: true` (`pnpm bundle:measure`) |
...
| 33 | ✅ | **Hot/Cold Decoupling** | 70.88 KiB gzip hot path isolated from 5-min Cron Workers; zero GC pauses |
...
| 60 | ⏳ | **Immutable B2B License** | Static 70.88 KiB gzip Worker hot path powering CaaS ecosystem subscriptions |
