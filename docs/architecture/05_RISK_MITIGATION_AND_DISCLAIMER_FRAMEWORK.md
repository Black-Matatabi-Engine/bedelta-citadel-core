...
> **Baseline:** Vitest **199 test files \| 868 PASS Clean (100% PASS)** · Wasm hot-path **50.94 KiB gzip** (`pkg/soil_core.wasm` **< 28 KiB**) · Shield **p50 ~106 µs**
...
| Anchor | Value |
|--------|-------|
| **Vitest baseline** | **199 test files \| 868 PASS Clean (100% PASS)** · `pnpm test -- --run` |
...
|-------|--------|-------------------|
| **A — V1.0** | ✅ Code-Verified (**199 test files \| 868 PASS Clean (100% PASS)**) | Arbitrum One GMX v2 / HL Δ-neutral · Wasm Shield · [ERC-8196](https://eips.ethereum.org/EIPS/eip-8196) (Final) policy gate · Gate `0xb174118b…` · Sepolia + One consume-once Gate |
...
| **Regression bar** | **199 test files \| 868 PASS Clean (100% PASS)** | No Wasm rewrite · additive swarm tests | No Wasm rewrite · CaaS SDK contract tests |
...
|-------|-------------------|----------|
| Full regression | `pnpm test -- --run` | **199 test files \| 868 PASS Clean (100% PASS)** |
...
| [`../sdk/ROBINHOOD_AGENTIC_RETAIL_WALLET_GUARD_BLUEPRINT.md`](../sdk/ROBINHOOD_AGENTIC_RETAIL_WALLET_GUARD_BLUEPRINT.md) | `@slivervine/robinhood-agentic-retail-wallet-guard` integration |
