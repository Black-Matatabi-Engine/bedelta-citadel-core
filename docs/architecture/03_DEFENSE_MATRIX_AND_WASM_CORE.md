...
>
> **Document:** R01–R20 defense matrix · sub-ms `soil_core` Wasm · microsecond moats · risk equations · **Vitest SSOT:** **225 test files | 1052 PASS clean** · **Defense Matrix:** `17 Active | 2 Refactored | 1 Deprecated` · **p50 ~106 µs**
> **Full Pillar Set Y audit:** [`03_DEFENSE_MATRIX_AND_WASM_CORE.md`](../architecture/03_DEFENSE_MATRIX_AND_WASM_CORE.md) · **Topology:** [`01_SYSTEM_TOPOLOGY_AND_YELLOW_PAPER.md`](./01_SYSTEM_TOPOLOGY_AND_YELLOW_PAPER.md)
...
**Build:** `pnpm run build:wasm` · **Tests:** [`tests/clock-monotonicity.test.ts`](../../tests/clock-monotonicity.test.ts) · **Verification:** [`docs/verifications/03_ADAPTER_INTEGRATION_PROOFS.md`](../verifications/03_ADAPTER_INTEGRATION_PROOFS.md)
...
**Vitest:** [`pendle-market-oracle.test.ts`](../../tests/adapters/pendle-market-oracle.test.ts) · [`pendle-pool-factory.test.ts`](../../tests/adapters/pendle-pool-factory.test.ts) · [`pendle-pt-registry.test.ts`](../../tests/adapters/pendle-pt-registry.test.ts) · [`pendle-soil-guard.test.ts`](../../tests/risk-control/pendle-soil-guard.test.ts) · [`usdai-adapter.test.ts`](../../tests/adapters/usdai-adapter.test.ts) · [`intent-sinking-audit.test.ts`](../../tests/core/intent-sinking-audit.test.ts) (**&lt;16 KiB** ring-slab gate) · **225 test files | 1052 PASS clean** · coexists with Shield **p50 ~106µs** budget.
...
**Status:** **17 Active | 2 Refactored | 1 Deprecated** · Full rule table: [`03_DEFENSE_MATRIX_AND_WASM_CORE.md`](../architecture/03_DEFENSE_MATRIX_AND_WASM_CORE.md#defense-matrix-r01-r20).
