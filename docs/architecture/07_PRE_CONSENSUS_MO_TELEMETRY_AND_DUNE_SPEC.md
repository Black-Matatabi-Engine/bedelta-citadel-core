...
> **Related:** [`06_HACKER_PROFILING_AND_TOXICOLOGY.md`](./06_HACKER_PROFILING_AND_TOXICOLOGY.md) · [`../telemetry/DUNE_DASHBOARD_SPECIFICATION.md`](../telemetry/DUNE_DASHBOARD_SPECIFICATION.md) · **Vitest:** **228 test files | 1064 PASS clean**
...
| **Latency** | Minutes → days (indexer lag + forensics) | **p50 ~15µs** reflex severance · **p50 ~106µs** E2E Edge Shield |
...
Toxic calldata — approve drains · batch-masked `wallet_sendCalls` · ERC-7540 `setOperator` hijacks · soil trips — is parsed at **u32 selector** resolution in [`calldata-parser.ts`](../../src/sdk/eip1193-agentic-wallet-guard/calldata-parser.ts) **before** any RPC forward. This is the **crime scene** for MO profiling ([`06_HACKER_PROFILING_AND_TOXICOLOGY.md`](./06_HACKER_PROFILING_AND_TOXICOLOGY.md)).

### 1.3 Relationship to Existing PEV (Prevented Exploit Volume)

| Layer | Schema | Role |
|-------|--------|------|
| **On-chain PEV** | `RiskTripBlocked` · `blocked_intent_notional_usd` | Settlement-plane mirror · Dune Query 1 ([`DUNE_DASHBOARD_SPECIFICATION.md`](../telemetry/DUNE_DASHBOARD_SPECIFICATION.md)) |
...
Sourced from [`RetailGuardReasonCode`](../../src/sdk/eip1193-agentic-wallet-guard/types.ts) · soil trip reasons · ERC-7683 · honeypot gates.
...
2. **`notional_usd_at_risk`** feeds PEV — use same reconciliation discipline as [`DUNE_DASHBOARD_SPECIFICATION.md`](../telemetry/DUNE_DASHBOARD_SPECIFICATION.md).
...
| Document | Purpose |
|----------|---------|
| [`06_HACKER_PROFILING_AND_TOXICOLOGY.md`](./06_HACKER_PROFILING_AND_TOXICOLOGY.md) | Mindhunter MO · Tang Sect toxicology framework |
| [`../telemetry/DUNE_DASHBOARD_SPECIFICATION.md`](../telemetry/DUNE_DASHBOARD_SPECIFICATION.md) | PEV · Query 0–3 · Sepolia ingest |
| [`04_STANDARD_COMPLIANCE_AND_EIP_WIKI.md`](./04_STANDARD_COMPLIANCE_AND_EIP_WIKI.md) | ExoMesh competitive matrix |
| [`../citadel/ERC7540_ASYNC_ESCORT_BREAKTHROUGH.md`](../citadel/ERC7540_ASYNC_ESCORT_BREAKTHROUGH.md) | Sanctuary async vault MO |
| [`05_RISK_MITIGATION_AND_DISCLAIMER_FRAMEWORK.md`](./05_RISK_MITIGATION_AND_DISCLAIMER_FRAMEWORK.md) | 88%/12% risk spectrum · PEV disclaimers |
