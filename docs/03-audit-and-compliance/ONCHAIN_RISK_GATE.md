# ONCHAIN_RISK_GATE.md — On-Chain Risk Gate Audit & Personal Operations SOP
...
This document governs on-chain smart contract and trading execution safeguards, including `checkVineShield()`, `checkSoilResistanceWithVine()`, and `vineWrapProtection()`.
