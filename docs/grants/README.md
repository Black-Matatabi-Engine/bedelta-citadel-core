...
> **Vitest SSOT:** **199 test files | 868 PASS Clean (100% PASS)** · `pnpm test -- --run`.
...
Shared SSOT: [`../architecture/README.md`](../architecture/README.md) · [`../sdk/README.md`](../sdk/README.md) · Docs router: [`../README.md`](../README.md)
