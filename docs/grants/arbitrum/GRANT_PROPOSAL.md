...
> **Vitest SSOT:** **193 test files | 840 PASS Clean (100% PASS)** · **3-Tier Security Matrix: 5/0/0 PASS** · Defense Matrix `17 Active | 2 Refactored | 1 Deprecated` · Wasm Core **<28kb Cloudflare budget, <60µs execution (<150µs P99 tail)** · Gate **`0xb174118bC0B84e8D6D59EEF2339e29bF7FCf8BF1`** (Mainnet + Sepolia CREATE2 same-address)
...
| Phase | Scope | Status |
|-------|-------|--------|
| Open House / Buildathon | Live HUD · Gate · Sepolia proof · **193 test files | 840 PASS Clean (100% PASS)** · 5-step E2E (`pnpm run demo:e2e`) | ✅ Submitted |
...
| Field | Locked value |
|-------|--------------|
| **Vitest baseline** | **193 test files | 840 PASS Clean (100% PASS)** |
...
```bash
pnpm install
pnpm test # 193 test files | 840 PASS Clean (100% PASS)
