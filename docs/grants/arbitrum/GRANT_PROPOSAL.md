...
> **Vitest SSOT:** **199 test files | 868 PASS Clean (100% PASS)** · **3-Tier Security Matrix: 5/0/0 PASS** · Defense Matrix `17 Active | 2 Refactored | 1 Deprecated` · Wasm Core **<28kb Cloudflare budget, <60µs execution (<150µs P99 tail)** · Gate **`0xb174118bC0B84e8D6D59EEF2339e29bF7FCf8BF1`** (Mainnet + Sepolia CREATE2 same-address)
...
| Field | Locked value |
|-------|--------------|
| **Vitest baseline** | **199 test files | 868 PASS Clean (100% PASS)** |
...
```bash
pnpm install
pnpm test # 199 test files | 868 PASS Clean (100% PASS)
