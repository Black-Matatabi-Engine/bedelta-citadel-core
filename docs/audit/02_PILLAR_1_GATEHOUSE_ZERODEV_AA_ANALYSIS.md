...
| **Baseline** | **Vitest SSOT:** **194 test files \| 845 PASS Clean (100% PASS)** · Wasm **70.16 KiB gzip** (`pkg/soil_core.wasm` **< 28 KiB**) · Shield **p50 ~106 µs** (TS Gateway path) · Wasm warm **&lt;60 µs** |
