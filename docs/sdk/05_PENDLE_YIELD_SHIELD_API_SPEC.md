...
Bind **Pendle PT collateral health** with **GMX v2** margin exposure and optional **Hyperliquid** hedge stress. Fail-closed before broadcast; powered by `evaluatePendleGmxCrossGuardFromRegistry` and optional `checkSoilResistance()` Wasm soil lane.
...
| — | [`../architecture/03_DEFENSE_MATRIX_AND_WASM_CORE.md`](../architecture/03_DEFENSE_MATRIX_AND_WASM_CORE.md) |
