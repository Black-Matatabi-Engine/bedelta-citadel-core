...
See [`04_AI_INTENT_PROTECTION_MODEL.md`](./04_AI_INTENT_PROTECTION_MODEL.md) for the full threat model.
...
| AI agent wallet frameworks (2026) | ElizaOS · LangChain · Virtuals · custom copilots | ExoMesh **EIP-1193 middleware** + B2B `withCitadelShield` |
...
| 04 | [`04_AI_INTENT_PROTECTION_MODEL.md`](./04_AI_INTENT_PROTECTION_MODEL.md) |
