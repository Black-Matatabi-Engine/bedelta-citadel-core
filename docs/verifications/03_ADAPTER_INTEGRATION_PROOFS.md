...
> **Vitest baseline:** **218 test files | 1032 PASS clean**
...
|-------|--------------|----------|------|
| **GMX v2** | [`gmx-v2-invariants.ts`](../../src/adapters/gmx/gmx-v2-invariants.ts) | `pnpm demo:gmx` | [`gmx-adapter.test.ts`](../../tests/adapters/gmx-adapter.test.ts) |
...
See [`docs/SSOT_VOCABULARY.md`](../SSOT_VOCABULARY.md) · [`docs/architecture/03_DEFENSE_MATRIX_AND_WASM_CORE.md`](../architecture/03_DEFENSE_MATRIX_AND_WASM_CORE.md).
...
| Audience | Start here |
|----------|------------|
| C-end wallet vendors | [`docs/sdk/01_SDK_INTEGRATION_BLUEPRINT.md`](../sdk/01_SDK_INTEGRATION_BLUEPRINT.md) |
...
| Full CLI map | [`02_CLI_ZONE_MAP.md`](./02_CLI_ZONE_MAP.md) |
