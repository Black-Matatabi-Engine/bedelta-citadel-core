...
**Official positioning:** Sub-ms 0-Gas Pre-Broadcast Safety Layer (SliverVine ExoMesh) & Risk Navigator for AI Agents on Arbitrum — see metadata table above.

| Judge pointer | SSOT document |
|---------------|---------------|
| Hybrid Pillar Sets X & Y · R01–R20 | [Architecture index §01–03](../01_architecture/README.md) · [Hybrid Pillar Sets X & Y](../01_architecture/01_SYSTEM_TOPOLOGY_AND_YELLOW_PAPER.md#ingress-three-pillar-architecture) · [Defense Matrix](../01_architecture/02_DEFENSE_MATRIX_AND_SSRC_CORE.md) |
...
| 🟢 **Session Key Blast-Radius Isolation** | Scoped `ORDER_EXECUTE` + **$5,000** notional cap · **session replay guard** — consume-once nonce + `expiresAt` | `executeHlSessionKeyOrder` |
...
**Verification:** `npx vitest run tests/guards/variational-instrument-guard.zero.test.ts` · architecture SSOT: [`01_SYSTEM_TOPOLOGY_AND_YELLOW_PAPER.md`](../01_architecture/01_SYSTEM_TOPOLOGY_AND_YELLOW_PAPER.md#10-exomesh-pre-consensus-shield-5-core-venue-matrix).

**V1.0 production scope:** Ephemeral Ignition Signers (`0x1111…`/`0x2222…`) on Mainnet Gate · GMX v2 dry-run/Vitest pre-flight guards · **GM Pool I/O channel CLOSED on 42161** (deposit [0xe31552...4774](https://arbiscan.io/tx/0xe3155220e464c375329838bb5ca8498226b8c8fa32c11929b7605070f7be4774) · withdraw [0xfd3601...e410](https://arbiscan.io/tx/0xfd3601dce5c2407d371186d8a24829994547ec8810f4a20c3e798d2fb67ae410)) · **Pendle Institutional Safety Sentinel** + **Pendle AI Guarded Pool Factory** · **EIP-1193 Retail Guard SDK** + **5-Core Venue guards** · Stabilizer Sepolia · Dune Sepolia live stream + 42161 SQL pre-compiled · **public open gateway** (`X-SliverVine-Tier: public` · 5 RPS) · V1.1 4-tier SaaS roadmap · Stylus V2.0 dual-execution coprocessor (`pnpm build:stylus`; EIP-1967 upgradeable proxy path) · **automated R20 severance on `FLAGS_*` trips** · **30s sliding-window pending OI defense** · Monte Carlo 87.39% toxic flow blocked (10,000-run simulation; nominal modeled capital).
...
* **0-Gas off-chain severance:** Arbitrum One Gate ([0xb174...8bf1](https://arbiscan.io/address/0xb174118bc0b84e8d6d59eef2339e29bf7fcf8bf1)) **engineered for 0-Gas Pre-Execution Off-Chain Severance**. SliverVine ExoMesh risk gates halt compromised payload signatures at the Edge **prior to mempool submission**, preserving **L2 state space cleanliness**.
...
Full derivations: [Technical Specification §3.1](../01_architecture/02_DEFENSE_MATRIX_AND_SSRC_CORE.md#31-microsecond-moats-summary) · [Verification Matrix](../06_verifications/01_VERIFICATION_MATRIX.md) · [`JUDGE_BRIEF.md`](../../JUDGE_BRIEF.md).
...
|-------|-------------------|------|
| **GM Vault Operator (Wallet B)** | GM Vault Operator (Wallet B) | **Dedicated exclusively** to GM LP deposit/withdraw · **no** HL keys · **no** GMX perp |
| **Hedge Engine Signer (Wallet A)** | Hedge Engine Signer (Wallet A) | Hyperliquid session-key **perp short** · 0-Gas · low latency |
...
| **On-Chain Settlement** | PolicyGuardV2 [0xfd98...8781](https://arbiscan.io/address/0xfd98cadb7018f692ec58cd4359e0c0399f4f8781) · MatrixSwitch [0x4129...f99b](https://arbiscan.io/address/0x4129aee97e68aa3712c56fe9ec48bf369782f99b) · RiskOracleV2 [0xfadb...ec93](https://arbiscan.io/address/0xfadb14759a3d3c7e976697de61bf62627f14ec93) | Phase A+B+C **Verified Live** · **`stylusCoprocessor=0`** → Pure Solidity fallback · 100% fail-closed without separate Stylus mainnet activation |
| **Gate ↔ PolicyGuardV2 Link** | `SliverVineGatePolicyLink` [0xe4ef...9af0](https://arbiscan.io/address/0xe4ef5350963241c49a29e72a4cf093208cd19af0) → Gate [0xb174...8bf1](https://arbiscan.io/address/0xb174118bc0b84e8d6d59eef2339e29bf7fcf8bf1) | **Verified Live** — setPolicyGuard [0x1b158a...a182](https://arbiscan.io/tx/0x1b158a4a40409e39215b76b5b12693c2802b49b190ecc0be97c986f167b9a182) · deploy [0x7ce414...0ad9](https://arbiscan.io/tx/0x7ce414b737c6efed4068034dadebd9f017e1e6eb832aba64e3ba656ac0380ad9) |
...
| Event | Tx |
|-------|-----|
| GM Deposit Multicall | [0xe31552...4774](https://arbiscan.io/tx/0xe3155220e464c375329838bb5ca8498226b8c8fa32c11929b7605070f7be4774) |
| GM LP → Router Approve | [0x30ec0b...b00e](https://arbiscan.io/tx/0x30ec0b7a9493f0c43edb257fd40f6d6f9258401e206357f3db7574b11071b00e) |
| GM Withdraw Multicall | [0xfd3601...e410](https://arbiscan.io/tx/0xfd3601dce5c2407d371186d8a24829994547ec8810f4a20c3e798d2fb67ae410) |

| Lane | Signer role | Venue | Responsibilities |
|------|-----------------|-------|------------------|
| **Hedge Engine Signer (Wallet A)** | Hedge Engine Signer (Wallet A) | Hyperliquid L1 | Perp margin · scoped **session keys** · 1× short IOC execution · cron via `runScheduledGmxHedgeCron` · GMX short **fallback builder** (simulate) |
| **GM Vault Operator (Wallet B)** | GM Vault Operator (Wallet B) | Arbitrum One | **GM LP I/O only** · **$2,500** ingress vault · **$2,400** GMX v2 GM LP · **+10 bps `uiFeeReceiver`** treasury rebate |
...
**Latency SSOT:** **p50 ~106 µs** Edge `checkSoilResistance()` · Wasm **<28kb Cloudflare budget, <60µs execution** · M2M reflex agent policy guard module &lt;12 µs. Full spec: [`README.md`](../01_architecture/README.md).

### Version Roadmap SSOT (V1.0 / V1.5 / V2.0)

| Horizon | Status | Scope |
|---------|--------|-------|
| **V1.0** | ✅ Code-Verified Live Baseline | Arbitrum One GMX v2 ETH/USDC GM + HL 1× short · Wasm `checkSoilResistance()` p50 ~106µs · **V1.0 Direct SDK / EIP-1193 Guard** (`withRetailGuardProvider`) · ⏳ **Framework Adapters Harness Specs** (Wayfinder · ElizaOS · Virtuals · LangChain — `tests/` harness only, not official Live plugins) · 5-Core venue CLI demos · Stabilizer Sepolia sandbox · [ERC-8196](https://eips.ethereum.org/EIPS/eip-8196) (Final) policy pre-validation · EIP-712 consume-once Gate [0xb174...8bf1](https://arbiscan.io/address/0xb174118bc0b84e8d6d59eef2339e29bf7fcf8bf1) · static `GET /api/grant-audit` SHA-256 provenance archive · **public open gateway** (`X-SliverVine-Tier: public` · 5 RPS) · Worker bundle **58.72 KiB gzip** · **244 test files | 1126 PASS** |
...
| **V2.0** | ⏳ Design Spec | **Institutional CaaS & Orbit Shield** — paid policy plane around the **already-shipped** Drop-in EIP-1193 Provider Middleware (`withRetailGuardProvider`) · Orbit L3s · ZeroDev Stage ⑦ Intent Composition (2PC ledger) |
...
* **Lean On-Chain Gate by Design**: On-chain logic is strictly **immutable and non-custodial** (no proxy, no ETH custody) so the hot path stays on Cloudflare Edge — `checkSoilResistance()` **p50 ~106µs**. Dual-contract core: `SliverVineGate.sol` (consume-once attestation, Mainnet [0xb174...8bf1](https://arbiscan.io/address/0xb174118bc0b84e8d6d59eef2339e29bf7fcf8bf1) + Sepolia [0xb174...8bf1](https://sepolia.arbiscan.io/address/0xb174118bc0b84e8d6d59eef2339e29bf7fcf8bf1)) + [`SliverVineAgentPolicyGuard.sol`](../../contracts/src/SliverVineAgentPolicyGuard.sol) ([ERC-8196](https://eips.ethereum.org/EIPS/eip-8196) (Final) agent-policy validation).
* **Mechanism**: Intercepts AI Trade Intents in the sub-millisecond off-chain pipeline ([agent policy guard module](../../src/core/agent-citadel-guard.ts)), validating soil fuse + deadman switch before settlement-layer EIP-712 (`SliverVineGate` domain) (0-Gas Fail-Closed).
...
* **Live Mainnet Smart Route (4663 → 42161):** ZeroDev Kernel v3 UserOp Hash [0x4c4ca1...964a](https://arbiscan.io/tx/0x4c4ca1362d4a50d4684662e633e728401478c29dbef13f49e109e68253b5964a) · Verified Tx [0x4c4ca1...964a](https://arbiscan.io/tx/0x4c4ca1362d4a50d4684662e633e728401478c29dbef13f49e109e68253b5964a) · Harness `pnpm tsx scripts/execute-smart-route-live-demo.ts`
...
* SliverVine ExoMesh operates as an **institutional pre-execution safety layer** for existing PT/YT exposure — **60s TTL Oracle** with **`PENDLE_ORACLE_STALE`** soil fuse · expiry **<7d** + yield jitter **>200 bps** → fail-closed
...
* **Phase A+B+C on-chain invariant stack:**
 ...
 * **Mainnet deploy (Verified Live · 42161):** [`scripts/deploy-policy-guard-v2-mainnet.ts`](../../scripts/deploy-policy-guard-v2-mainnet.ts) · `SliverVineRiskOracleV2` [0xfadb...ec93](https://arbiscan.io/address/0xfadb14759a3d3c7e976697de61bf62627f14ec93) · `GmxSoilMatrixSwitch` [0x4129...f99b](https://arbiscan.io/address/0x4129aee97e68aa3712c56fe9ec48bf369782f99b) · `PolicyGuardV2` [0xfd98...8781](https://arbiscan.io/address/0xfd98cadb7018f692ec58cd4359e0c0399f4f8781) · `stylusCoprocessor=0`.
 ...
 * **Deposit multicall:** [0xe31552...4774](https://arbiscan.io/tx/0xe3155220e464c375329838bb5ca8498226b8c8fa32c11929b7605070f7be4774) · Block **503036082** · `pnpm execute:gmx:gm-deposit`
 * **GM LP → GMX v2 Router approve:** [0x30ec0b...b00e](https://arbiscan.io/tx/0x30ec0b7a9493f0c43edb257fd40f6d6f9258401e206357f3db7574b11071b00e) · Block **503051738** · spender `0x7452c558…`
 * **Withdraw multicall:** [0xfd3601...e410](https://arbiscan.io/tx/0xfd3601dce5c2407d371186d8a24829994547ec8810f4a20c3e798d2fb67ae410) · Block **503051752** · `pnpm execute:gmx:gm-withdraw`
* **Mainnet micro-fill harness:** `pnpm execute:gmx:micro-fill --size=1` — calibrated **$1–$20** GMX v2 increase order via PolicyGuardV2 [0xfd98...8781](https://arbiscan.io/address/0xfd98cadb7018f692ec58cd4359e0c0399f4f8781) + Gate [0xb174...8bf1](https://arbiscan.io/address/0xb174118bc0b84e8d6d59eef2339e29bf7fcf8bf1) · **automatic low-OI side calibration** (balanced market leg) · Live: `CONFIRM_GMX_MICRO_FILL=YES BROADCAST=1 MAINNET_PK=0x… ZERODEV_PROJECT_ID=…` · [`scripts/execute-gmx-mainnet-micro-fill.ts`](../../scripts/execute-gmx-mainnet-micro-fill.ts)
...
* **Stylus mainnet (verified):** `SliverVineSoilCoprocessor` [0xc235...625e](https://arbiscan.io/address/0xc23587d6573dd134f95b02b0202ffbf84686625e) · activation tx [0x92079e...9397](https://arbiscan.io/tx/0x92079e150697717af75b0b750ff80be36d06212337189ef368bf65fead6c9397) · Nitro Prover JIT + **ArbWasm `0x71`** · `pnpm deploy:stylus:mainnet` · [`scripts/deploy-stylus-mainnet.ts`](../../scripts/deploy-stylus-mainnet.ts)
...
|---------|---------|--------|-----------------|
| **Arbitrum Sepolia** | `421614` | ✅ **Active Live Event Pipeline** | Dune ingests decoded `IntentAttested` · `RiskTripBlocked` from Sepolia Gate [0xb174...8bf1](https://sepolia.arbiscan.io/address/0xb174118bc0b84e8d6d59eef2339e29bf7fcf8bf1) — **only** Sepolia claimed as live stream |
...
* **Sepolia event streaming (verified):** Dune engine ingests **decoded events** from Sepolia Gate [0xb174...8bf1](https://sepolia.arbiscan.io/address/0xb174118bc0b84e8d6d59eef2339e29bf7fcf8bf1) (`IntentAttested` · `RiskTripBlocked`) — **only** Sepolia is claimed as active live stream.
...
* **Live Telemetry Feed (Query 0):** `arbitrum.blocks` 12h window · Sepolia Gate [0xb174...8bf1](https://sepolia.arbiscan.io/address/0xb174118bc0b84e8d6d59eef2339e29bf7fcf8bf1) · `RiskTripBlocked` / `IntentAttested` / heartbeat status.
...
**Matrix 2 — AI Agent Wallet Policy & ExoMesh Execution Shield**
...
> **Pricing model boundary:** **v1.0 = Public Open Gateway** (`X-SliverVine-Tier: public` · `X-SliverVine-RPS-Limit: 5`) for Buildathon evaluation. **V1.1 = 4-Tier SaaS** ($10 / $99 / $299 / $1,999+) with KV API Key metering (Milestone 1 post-grant). **V2.0 = Institutional CaaS & Orbit Shield** (`@slivervine/exomesh-agentic-wallet-guard`) — do not conflate with v1.0 gateway or GMX +10 bps `uiFeeReceiver`.
>
> *V1.0 Buildathon Baseline: Open-access Public Gateway (No API key required; rate-limited to 5 RPS via `X-SliverVine-Tier: public`). V1.1 Cloudflare KV API Key Metering ($10–$1,999/mo) represents our Post-Grant Commercial Roadmap.*
 ...
 * Gateway responses include `X-SliverVine-Tier` (`starter` | `pro` | `business` | `enterprise`) and `X-SliverVine-RPS-Limit` (`5` | `50` | `200` | `1000`).
...
| **Business ExoMesh** | **$299** | **$2,870/yr** | **200** | **20M** | Priority memory queue · R20 auto-severance · tenant isolation |
...
- **Stage 1: Buildathon Verification Phase (Active Now — Pre-9/14)**
 ...
 - **Sepolia Safety Gate**: Full EIP-712 session key validation and 0-Gas Fail-Closed protection verified on Arbitrum Sepolia ([0xb174...8bf1](https://sepolia.arbiscan.io/address/0xb174118bc0b84e8d6d59eef2339e29bf7fcf8bf1)).
 ...
 * Submit official native plugin Pull Requests (PRs) to **ElizaOS** (`@elizaos/plugin-exomesh`) and **Virtuals GAME** (`@virtuals/plugin-exomesh`) monorepos, transitioning from the current zero-overhead SDK Wrapper decorator (`withExoMeshShield`) to official upstream integration.
...
* **Phase 3: Milestone ExoMesh Shield (Day 60 – 90)**
...
| **M-RH-Demo** | `4663` → `42161` outbound Smart Route **Verified Live** · UserOp `0x7b72ee9f4dc3f32f08a5de914ecf076c243d895522ecd72d17a2f7b025bc956d` · Tx [0x4c4ca1...964a](https://arbiscan.io/tx/0x4c4ca1362d4a50d4684662e633e728401478c29dbef13f49e109e68253b5964a) · inbound AML blocked · `lostUsd ≡ 0` | Robinhood Chain | ✅ Live-verified |
...
| **M6-Mainnet** | Arbitrum One Gate ignition on `42161` · Gate [0xb174...8bf1](https://arbiscan.io/address/0xb174118bc0b84e8d6d59eef2339e29bf7fcf8bf1) · [0x54c153...b0c6](https://arbiscan.io/tx/0x54c153e9a41f704b5eb0ae554eac593d1110d62bd826ff094e72f2bd60c1b0c6) | Arbitrum · Grant | ✅ Delivered |
...
|----------|------|----------------------------|-------|
| `SliverVineGate` | Consume-once EIP-712 attestation anchor | [0xb174...8bf1](https://arbiscan.io/address/0xb174118bc0b84e8d6d59eef2339e29bf7fcf8bf1) | Mainnet Ignition Tx [0x54c153...b0c6](https://arbiscan.io/tx/0x54c153e9a41f704b5eb0ae554eac593d1110d62bd826ff094e72f2bd60c1b0c6) · [`DeployArbitrumOneGate.s.sol`](../../SliverVineGate/script/DeployArbitrumOneGate.s.sol) |

> **Governance footnote (Bootstrap Ignition Keys):** Mainnet Gate [0xb174...8bf1](https://arbiscan.io/address/0xb174118bc0b84e8d6d59eef2339e29bf7fcf8bf1) deploys with **Bootstrap Ignition Keys** (`0x1111…` / `0x2222…`) — **strictly for public verification and sandbox reproducibility**, not production HSM custody. Governance authority is designed for **post-launch rotation** to production multisig via native `proposeAdmin` / `acceptAdmin` functions.

> **0-Gas Off-Chain Severance architecture:** Arbitrum One Gate ([0xb174...8bf1](https://arbiscan.io/address/0xb174118bc0b84e8d6d59eef2339e29bf7fcf8bf1)) **is engineered for 0-Gas Pre-Execution Off-Chain Severance**. SliverVine ExoMesh risk gates halt compromised payload signatures at the Edge **prior to mempool submission**, preserving **Arbitrum L2 state space cleanliness** — toxic paths never consume Sequencer gas; on-chain Gate anchors consume-once attestations only for cleared intents.
...
| Field | Value |
|-------|-------|
| **PolicyGuardV2 (current · Phase A+B+C)** | [0xfd98...8781](https://arbiscan.io/address/0xfd98cadb7018f692ec58cd4359e0c0399f4f8781) · Deploy [0xcd5206...306a](https://arbiscan.io/tx/0xcd520602a277c0781038552d5692f5ad43076a8928f5e7384e695642f980306a) |
| **Gate PolicyLink (bootstrap Gate binding)** | [0xe4ef...9af0](https://arbiscan.io/address/0xe4ef5350963241c49a29e72a4cf093208cd19af0) · setPolicyGuard [0x1b158a...a182](https://arbiscan.io/tx/0x1b158a4a40409e39215b76b5b12693c2802b49b190ecc0be97c986f167b9a182) · Deploy [0x7ce414...0ad9](https://arbiscan.io/tx/0x7ce414b737c6efed4068034dadebd9f017e1e6eb832aba64e3ba656ac0380ad9) |
| **GmxSoilMatrixSwitch** | [0x4129...f99b](https://arbiscan.io/address/0x4129aee97e68aa3712c56fe9ec48bf369782f99b) · oracle [0xfadb...ec93](https://arbiscan.io/address/0xfadb14759a3d3c7e976697de61bf62627f14ec93) |
| **SliverVineRiskOracleV2** | [0xfadb...ec93](https://arbiscan.io/address/0xfadb14759a3d3c7e976697de61bf62627f14ec93) |
| **PolicyGuard v1 (superseded)** | [0xc66f...8959](https://arbiscan.io/address/0xc66f96611a737c4e58706d0955594456eab88959) · Deploy [0xeabd5f...4b0c](https://arbiscan.io/tx/0xeabd5fd17f1e8684c3408887a233a8ac26220199781b401336233a3072fb4b0c) |
| **PolicyGuard (legacy v0)** | [0x3e42...fb4b](https://arbiscan.io/address/0x3e4298e2b8d4e30396a54c1817eb71c9272ffb4b) · Deploy [0x77fd8e...74fa](https://arbiscan.io/tx/0x77fd8e1c702ca19e9fa0621a1f6b0e8de6701f389d062cc3427e3d8d3d1e74fa) |
| **ZeroDev Kernel v3 AA Proof Tx** | [0xc7659e...4aad](https://arbiscan.io/tx/0xc7659e299e4961279f03b9cafa988dc082d7f9baf107bcd7b62812e8dfb54aad) |
| **Smart Route Source Chain** | Robinhood Mainnet (`4663`) |
| **Smart Route Target Chain** | Arbitrum One (`42161`) |
| **ZeroDev Kernel v3 Smart Route UserOp Hash** | [0x4c4ca1...964a](https://arbiscan.io/tx/0x4c4ca1362d4a50d4684662e633e728401478c29dbef13f49e109e68253b5964a) |
| **ZeroDev Kernel v3 Smart Route UserOp Tx** | [0x4c4ca1...964a](https://arbiscan.io/tx/0x4c4ca1362d4a50d4684662e633e728401478c29dbef13f49e109e68253b5964a) |
...
|----------|------|----------------------------|--------|
| **Deployer / Admin / Signer** | OpSec-isolated Forge broadcast signer | [0xbd65d785Dac74EBa9efFdB357b2dC52fCC26EC7F](https://sepolia.arbiscan.io/address/0xbd65d785dac74eba9efgdb357b2dc52fcc26ec7f) | [`scripts/deploy-sepolia-gate.sol`](../../scripts/deploy-sepolia-gate.sol) |
| `SliverVineGate` | Consume-once EIP-712 attestation anchor | [0xb174...8bf1](https://sepolia.arbiscan.io/address/0xb174118bc0b84e8d6d59eef2339e29bf7fcf8bf1) | [`SliverVineGate/src/SliverVineGate.sol`](../../SliverVineGate/src/SliverVineGate.sol) |
| `SliverVineRiskOracle` | EIP-712 offline risk report · `STATUS_SHUTDOWN` flush | [0x3ffa...53a4](https://sepolia.arbiscan.io/address/0x3ffa2539f502682e8145e6eb427ff78d258d53a4) | [`contracts/SliverVineRiskOracle.sol`](../../contracts/SliverVineRiskOracle.sol) |
| `IngressSafetySwitch` | Pillar Set X compliance filter | [0x3e42...fb4b](https://sepolia.arbiscan.io/address/0x3e4298e2b8d4e30396a54c1817eb71c9272ffb4b) | [`contracts/IngressSafetySwitch.sol`](../../contracts/IngressSafetySwitch.sol) |
...
**Regression bar:** Vitest **244 test files | 1126 PASS** · **3-Tier Security Matrix: 5/0/0 PASS (Vitest, Forge, Slither, Aderyn, pnpm-audit)** · Forge 60/60 · Cargo Stylus 9/9 · Worker bundle **58.72 KiB gzip** (`pnpm bundle:measure` · pass &lt;75 KiB) · Wasm **<28kb Cloudflare budget, <60µs execution** · Shield **p50 ~106µs**.
...
|-----------|-----------------------------------|---------------|-------------------------|----------------------|--------------------------------------|
| **Pre-broadcast severance** | ✅ Sub-ms Wasm soil fuse (p50 ~106µs) · 0-Gas fail-closed | ✅ **V1.0 Live** via SliverVine ExoMesh `withExoMeshShield` Wayfinder hook on Arbitrum `42161` | ❌ Web2.5 agent layer; wallets exposed without pre-execution bounds | ❌ No native pre-broadcast risk gates | ❌ Session keys only; **no** AI-context fuse |
...
|-----------|-------------------------|
| **Architecture Principle: Upstream Pre-Consensus Severance** | Physical signing-channel severance (`severSigningChannel()`) enforced **upstream** of L2 Sequencer ingress, AA Bundler, and UserOp relayer via EIP-1193 RPC middleware (`withExoMeshShield`) — 0-Gas pre-consensus bitmask evaluation prevents Sequencer queue pollution. |
