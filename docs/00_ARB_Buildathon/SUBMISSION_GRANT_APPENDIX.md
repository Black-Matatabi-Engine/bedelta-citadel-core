...
**Latency SSOT:** **p50 ~106 µs** Edge `checkSoilResistance()` · Wasm **<28kb Cloudflare budget, <60µs execution** · M2M reflex `src/core/agent-citadel-guard.ts` &lt;12 µs. Full spec: [`README.md`](../01_architecture/README.md).
