...
| **Tier 1 — Full Protocol Regression** | `[ExoMesh]` | `pnpm test -- --run` | **231 files / 1081 PASS** · `pnpm exec tsc --noEmit` 0 errors |
...
| `pnpm test` | Full Vitest regression bar | **231 test files | 1081 PASS clean** |
...
| `docker run --rm slivervine-citadel pnpm test` | Full Vitest regression (host-free) | **231 test files | 1081 PASS clean** |
