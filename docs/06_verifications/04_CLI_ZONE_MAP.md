...
| **Tier 1 — Full Protocol Regression** | `[ExoMesh]` | `pnpm test -- --run` | **235 files / 1091 PASS** · `pnpm exec tsc --noEmit` 0 errors |
...
| `pnpm demo:agent` | B2B `withExoMeshShield` smoke demo | `ALLOW` / intent gate |
