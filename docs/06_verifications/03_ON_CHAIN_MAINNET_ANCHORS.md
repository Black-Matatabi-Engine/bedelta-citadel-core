...
| **B2B agent decorator** | `withExoMeshShield` · `verifyAgentIntent()` — framework-agnostic pre-broadcast wrapper | [decorator.ts](../../src/sdk/decorator.ts) · `pnpm demo:agent` |
...
| **Agent SDK decorator** | `withExoMeshShield` — zero-touch pre-broadcast wrapper | [src/sdk/decorator.ts](../../src/sdk/decorator.ts) · [examples/agent-interceptor-demo.ts](../../examples/agent-interceptor-demo.ts) |
