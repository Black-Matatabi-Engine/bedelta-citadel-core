...
| **04** | [`04_CLI_ZONE_MAP.md`](./04_CLI_ZONE_MAP.md) | Zone A / A.1 / B / C CLI command tables (Tier 0–3) · Module B Vault: `pnpm demo:sanctuary` · Module B Ingress: `pnpm demo:ingress` |
