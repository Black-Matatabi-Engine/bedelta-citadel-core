...
> **Vitest SSOT:** **218 test files | 1032 PASS clean** on `pnpm test -- --run`.  
...
**Pruned venues (v1.1):** Uniswap V3 · Aave V3 · Morpho Blue — Wasm ABI v2 **RESERVED_ABI_V2** holes preserved at protocol bits 4–6. See [`docs/SSOT_VOCABULARY.md`](./SSOT_VOCABULARY.md).
