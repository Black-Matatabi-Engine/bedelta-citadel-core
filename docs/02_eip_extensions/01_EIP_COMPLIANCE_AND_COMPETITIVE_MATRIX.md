...
| **Proof discipline** | Vendor claims · post-mortem | **231 test files \| 1081 PASS** · `pnpm exec tsc --noEmit` 0 errors · `pnpm demo:gmx -- --trip` live severance |
...
| Anchor | Value |
|--------|-------|
| **Vitest baseline** | **231 test files | 1081 PASS clean** · `pnpm test -- --run` · `pnpm exec tsc --noEmit` **0 errors** |
...
| **Verification** | [`02_DEFENSE_MATRIX_AND_SSRC_CORE.md`](../01_architecture/02_DEFENSE_MATRIX_AND_SSRC_CORE.md) · `tests/risk-control/*` · Vitest **231 test files | 1081 PASS clean** |
