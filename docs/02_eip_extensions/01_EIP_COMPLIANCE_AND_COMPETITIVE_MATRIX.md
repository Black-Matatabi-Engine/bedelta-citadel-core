...
| **Memory model** | Per-RPC heap churn · `BigInt` / object alloc on hot path | **Zero-GC ring slab** — `INTENT_RING_U32` · `CALLDATA_SCRATCH` · `SOIL_LANE_SCRATCH` · reusable `DataView` FFI buffers |
