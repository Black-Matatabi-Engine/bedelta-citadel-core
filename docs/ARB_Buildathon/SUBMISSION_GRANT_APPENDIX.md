...
| **EIP-1193 Retail Guard** | Universal C-end wallet middleware | `withRetailGuardProvider()` · 0-Gas pre-consensus intercept | `src/sdk/eip1193-agentic-wallet-guard/` · `npx vitest run tests/sdk/retail-guard-provider.test.ts` |
