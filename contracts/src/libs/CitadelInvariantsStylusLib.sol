...
import {ICitadelInvariantsCoprocessor} from "../interfaces/ICitadelInvariantsCoprocessor.sol";

/// @dev Stylus staticcall helper — parse 32-byte packed result word (LE layout from Rust).
library CitadelInvariantsStylusLib {
        ...
        returns (bool invoked, uint256 errMask)
    {
        ...
        (bool ok, bytes memory ret) =
            coprocessor.staticcall(abi.encodeWithSelector(ICitadelInvariantsCoprocessor.evaluatePacked.selector, packed));
