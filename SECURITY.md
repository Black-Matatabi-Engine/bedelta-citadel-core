...
**KV tenancy:** Single namespace ID with strict key-prefix isolation (`exec:*`, `state:*`, `sys:*`). See `wrangler.toml` comments and [docs/01_architecture/README.md](./docs/01_architecture/README.md).
