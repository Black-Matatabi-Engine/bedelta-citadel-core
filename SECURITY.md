...
**KV tenancy:** Single namespace ID with strict key-prefix isolation (`exec:*`, `state:*`, `sys:*`). See `wrangler.toml` comments and [docs/architecture/README.md](./docs/architecture/README.md).
...
| Document | Purpose |
|----------|---------|
| [docs/architecture/README.md](./docs/architecture/README.md) | Topology · R01–R20 · KV isolation |
