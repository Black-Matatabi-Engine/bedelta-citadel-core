...
const TAIJI_YANG_CRI_MIN = ${TAIJI_YANG_CRI_MIN};
const TAIJI_YIN_CRI_MIN = ${TAIJI_YIN_CRI_MIN};
...
const BAGUA_KAN_CRI_MAX = ${BAGUA_KAN_CRI_MAX};
const BAGUA_LI_CRI_MIN = ${BAGUA_LI_CRI_MIN};
`.trim();
