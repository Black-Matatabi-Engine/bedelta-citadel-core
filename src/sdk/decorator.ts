 ...
 *
 * SliverVine ExoMesh B2B decorator — zero-touch wrapper for Virtuals / ElizaOS / LangChain
 * agent hooks. Routes intents through ReflexCore (SSRC) `checkSoilResistance()` before
