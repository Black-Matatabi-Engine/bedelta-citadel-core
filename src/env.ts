...
export interface Env {
  ...
  /** Strike alpha — inject via Wrangler vars (see docs/01_architecture/01_SYSTEM_TOPOLOGY_AND_YELLOW_PAPER.md) */
  ...
  /** Coach alpha — inject via Wrangler vars (see docs/01_architecture/01_SYSTEM_TOPOLOGY_AND_YELLOW_PAPER.md) */
