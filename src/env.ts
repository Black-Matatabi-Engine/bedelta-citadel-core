...
export interface Env {
  ...
  /** Strike alpha — inject via Wrangler vars (see docs/01_architecture/01_TECHNICAL_SPECIFICATION.md) */
  ...
  /** Coach alpha — inject via Wrangler vars (see docs/01_architecture/01_TECHNICAL_SPECIFICATION.md) */
