...
import { evalCounterAttackOpportunity } from "./counter-attack-matrix";
import {
...
export const SOAK_TELEMETRY_COINS = ["BTC", "ETH"] as const;
...
/** Run one 1-minute cron-equivalent soak telemetry tick (BTC + ETH). */
...
export { DEFAULT_COUNTER_ATTACK_COIN };
