...
**Regression bar:** **194 test files | 845 PASS Clean (100% PASS)** · `tsc --noEmit` CLEAN
...
| Full Vitest bar | `docker run --rm slivervine-citadel pnpm test` → **194 test files | 845 PASS Clean (100% PASS)** |
