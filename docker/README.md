...
**Regression bar:** **193 test files | 840 PASS Clean (100% PASS)** · `tsc --noEmit` CLEAN
...
| Full Vitest bar | `docker run --rm slivervine-citadel pnpm test` → **193 test files | 840 PASS Clean (100% PASS)** |
