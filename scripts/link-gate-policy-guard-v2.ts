...
const POLICY_GUARD_V2 = "0xfd98cadb7018f692ec58cd4359e0c0399f4f8781" as Address;
...
async function gateHasNativeSetter(client: ReturnType<typeof createPublicClient>): Promise<boolean> {
...
async function main(): Promise<void> {
  ...
  const native = await gateHasNativeSetter(client);
